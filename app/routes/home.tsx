    ...
    <>
      <div className="home">
        ...
        <section className="hero">
          ...
          <h1>Build beautiful spaces at the speed of thought with remote Roomify</h1>

          <p className="subtitle">
            Roomify is an AI-first design enviroment that helps you visualize, render and ship architecture projects faster then ever
          </p>
